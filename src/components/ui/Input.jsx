export default function Input({ text, type, id, color, background }) {
  return (
    <div className="relative w-full">
      ...
      <label
        htmlFor={id}
        className={`absolute left-3 top-1/2 -translate-y-1/2 text-sm text-gray-500 bg-${background} cursor-text select-none
